...
function drawGraph() {
    ...
    for (const vertex in graph) {
        ...
        // Draw cost value with better visibility
        ctx.fillStyle = '#4A90E2';
        ctx.font = 'bold 14px Inter';
        ctx.fillText(`c:${graph[vertex].heuristic}`, x, y + 30);
    }
...
function updateInfo() {
    ...
    if (currentVertex !== null && graph[currentVertex]) {
        ...
        observation.innerHTML = `
            ...
            <p><strong>Edge Cost:</strong><br>${heuristicCosts.join(', ') || 'none'}</p>
            <p><strong>Total Cost:</strong><br>${totalCosts.join(', ') || 'none'}</p>
        ...
        observation.innerHTML = `
            ...
            <p><strong>Edge Cost:</strong><br>none</p>
            <p><strong>Total Cost:</strong><br>none</p>
        `;
    }
}
